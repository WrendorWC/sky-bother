...
enum HelpContent {
    static let topics: [HelpTopic] = [
        HelpTopic(title: "Getting Started", systemImage: "sparkles", sections: [
            ...
            HelpSection(heading: "Running It Later", body: "Use the “Setup Wizard” button at the top of any Settings tab, or “Setup Wizard” at the foot of the night list. It isn’t available while the planner has unsaved changes.")
        ]),
        ...
        HelpTopic(title: "Sky View", systemImage: "globe", sections: [
            ...
            HelpSection(heading: "Playback", body: "“Play” (Space) runs the night in about 25 seconds; dragging the time bar pauses it. With Reduce Motion on, it steps 15 minutes at a time. “Follow planned targets” selects each planned target as its block starts, fading from one to the next, and fades it out during gaps between blocks and after the last one; “Stay on selected target” keeps the selection.")
        ]),
        ...
        HelpTopic(title: "The Plan", systemImage: "list.number", sections: [
            ...
            HelpSection(heading: "The Planner", body: "Open it with “Plan Session” or “Edit Plan”. Click the date to switch to another night. The night, site and rig stay at the top, the timeline below them, then candidates on the left and the selected target on the right. Behind the timeline’s blocks are the night’s conditions — twilight to dark, cloud from the top, moonlight — and hovering the timeline gives the time, darkness, cloud and Moon altitude. Only the candidate list scrolls. Drag the divider to resize the panels."),
...
struct HelpView: View {
    ...
    var body: some View {
        ...
        .background(FitWindowToContent(minHeight: 640))
    }
}
