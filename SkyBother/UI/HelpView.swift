...
enum HelpContent {
    static let topics: [HelpTopic] = [
        ...
        HelpTopic(title: "The Plan", systemImage: "list.number", sections: [
            ...
            HelpSection(heading: "Adding Targets", body: "Add puts a block in the longest free stretch, preferring time the target can actually be shot. The same target can have several blocks. “Remove” on a candidate, or “Remove from plan” in the Selected target panel, takes a target’s blocks out; “Remove block” under the timeline (or Delete) removes just the selected block. If the list doesn’t have what you want, “Browse full catalog” at the end of it opens the catalog for the same night."),
