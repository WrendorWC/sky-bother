...
enum HelpContent {
    static let topics: [HelpTopic] = [
        ...
        HelpTopic(title: "Tonight's Plan", systemImage: "list.number", sections: [
            ...
            HelpSection(heading: "Editing the Plan", body: "\u{201c}Edit plan,\u{201d} beside the section title, turns the strip into something you build on. It starts from whatever the app was already suggesting \u{2014} the scheduler usually has the shape of the night about right, and the edits worth making are moving one block and splitting another, not starting from nothing. Drag a block along the night to move it; drag either end to change how long you spend there. Blocks stop against their neighbours rather than pushing through them, because one telescope can only point at one thing at a time, and every edit snaps to the nearest five minutes so times stay readable. \u{201c}Clear\u{201d} empties the night and leaves it empty; \u{201c}Reset\u{201d} throws your version away and hands the night back to the scheduler. \u{201c}Done\u{201d} puts the strip back to being a picture \u{2014} your plan is saved either way, per night, and survives quitting the app."),
