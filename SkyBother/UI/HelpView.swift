...
enum HelpContent {
    static let topics: [HelpTopic] = [
        ...
        HelpTopic(title: "The Plan", systemImage: "list.number", sections: [
            ...
            HelpSection(heading: "The Planner", body: "Open it with “Plan Session” or “Edit plan”. Click the date to switch to another night. The night, site and rig stay at the top, the timeline below them, then candidates on the left and the selected target on the right. A thin strip above the timeline shows the night’s conditions — twilight to dark, cloud from the top, moonlight — and hovering it gives the time, darkness, cloud and Moon altitude. Only the candidate list scrolls. Drag the divider to resize the panels."),
