...
- **What's up** — 159 deep-sky targets, when each one clears your horizon, and for how long.
...
- **Catalogue**: the complete Messier list plus 49 non-Messier showpieces,
  compiled into the app. Positions are J2000, quoted to about an arcminute.
...
SkyBother/
  ...
  Catalog/    The 159-target built-in catalogue
